 ...
 <?php
    ...
    $expets = $services->services("astrologer");
    ?>
     ...
     <div class="layout-px-spacing">
         ...
         <div class="page-header">
             <div class="page-title">
                 <h3>Astrologers</h3>
                 <a class="btn" id="addTask" href="adddata.php?type=astrologer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                         <line x1="12" y1="5" x2="12" y2="19"></line>
                         <line x1="5" y1="12" x2="19" y2="12"></line>
                     </svg>New Astrologer</a>
             </div>
         </div>
         ...
         <div class="row" id="cancel-row">
                                 ...
                                 <?php $i = 1;
                                    foreach ($expets as $expet) { ?>
                                     <tr>
                                         ...
                                         <td><a href="javascript:void(0)" onclick="viewdata(<?php echo $expet["ID"]; ?>)" class="btn" id="view">View</td>
                                         <td>
             ...
             <div class="col-xl-4 col-lg-4 col-sm-4  layout-spacing" id="dataview" style="display: none;">
                 ...
                 <div class="card component-card_9">
                     ...
                     <img src="" class="card-img-top" alt="none">
