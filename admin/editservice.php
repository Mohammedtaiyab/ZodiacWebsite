 ...
 <?php
    ...
    $aboutus = $services->getdatabyid($id);
             ...
             <div class="col-xl-8 col-lg-8 col-sm-8  layout-spacing">
                 <div class="widget-content widget-content-area br-6">
                     <form method="post" action="function.php" enctype="multipart/form-data">
                         <input type="hidden" name="pagename" value="<?php echo $aboutus[0]["Type"]; ?>">
                         <input type="hidden" name="page" value="<?php echo $aboutus[0]["ID"]; ?>">
                         <div class="input-group mb-5">
                             <div class="input-group-prepend">
                                 <span class="input-group-text" id="basic-addon6">Title</span>
                             </div>
                             <input type="text" class="form-control" placeholder="Title" aria-label="Recipient's username" aria-describedby="basic-addon2" name="topic" value="<?php echo $aboutus[0]["Title"]; ?>">
                         </div>
                         ...
                         <div class="input-group mb-4">
                             <input type="submit" class="form-control btn btn-primary btn-rounded mb-2" name="saveservice" value="Save">
                         </div>
                     </form>
                 </div>
             </div>
