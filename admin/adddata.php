             ...
             <div class="col-xl-8 col-lg-8 col-sm-8  layout-spacing">
                 <div class="widget-content widget-content-area br-6">
                     <form method="post" action="function.php" enctype="multipart/form-data">
                         <input type="hidden" name="pagename" value="<?php echo $_GET["type"]; ?>">
              
                         <div class="input-group mb-5">
                             <div class="input-group-prepend">
                                 <span class="input-group-text" id="basic-addon6">Title</span>
                             </div>
                             <input type="text" class="form-control" placeholder="Title" aria-label="Recipient's username" aria-describedby="basic-addon2" name="topic" value="">
                         </div>
                         ...
                         <textarea class="form-control mb-4" id="paragraph" name="paragraph" aria-label="With textarea"></textarea>
                         <div class="input-group mb-4 mt-4">
                             <div class="input-group-prepend">
                                 <span class="input-group-text" id="basic-addon5">Button Text</span>
                             </div>
                             <input type="text" class="form-control" value="" name="buttontitle" placeholder="Button Title/Text" aria-label="Username">
                         </div>
                         ...
                         <div class="input-group mb-4">
                             ...
                             <input type="text" class="form-control" value="" id="basic-url" name="buttonlink" aria-describedby="basic-addon3" placeholder="/index.php">
                         </div>
                         ...
                         <div class="input-group mb-4">
                             <input type="submit" class="form-control btn btn-primary btn-rounded mb-2" name="addservice" value="Save">
                         </div>
                     </form>
