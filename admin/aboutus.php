         ...
         <div class="row" id="cancel-row">
                             ...
                             <tbody>
                                 <?php $i = 1;
                                    foreach ($aboutus as $expet) { ?>
                                     <tr>
                                         <td><?php echo $i; ?></td>
                                         <td><?php echo $expet["Topic"]; ?></td>
                                         <!-- <td><?php echo $expet["Description"]; ?></td> -->
             ...
             <div class="col-xl-4 col-lg-4 col-sm-4  layout-spacing" id="dataview" style="display: none;">
                 ...
                 <div class="card component-card_9">
                     ...
                     <img src="" id="img" class="card-img-top" alt="none">
     ...
     function viewdata(id) {
         $.ajax({
             ...
             success: function(data) {
                 ...
                 $("#title").html(data[0].Topic);
                 $("#description").html(data[0].Description);
                 $("#paragraph").append(data[0].Paragraph);
