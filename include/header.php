                ...
                <div class="container">
                    <div class="header-menu-content">
                        <nav class="navbar navbar-expand-lg p-0">
                            <a class="site-logo site-title" href="index.php"><img src="assets/images/logo2.png" alt="site-logo" style="width: 4rem;height: 4rem;"><img src="assets/images/logo1.png" alt="site-logo" style="width: 9rem;"></a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav main-menu ml-auto">
                                    ...
                                    <li><a class="btn btn-primary custome-button" href="#" role="button">Download App</a></li>
                                </ul>
